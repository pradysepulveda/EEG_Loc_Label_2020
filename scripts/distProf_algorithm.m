...
% *** modified to be able to extract d_sort and later plot the distance
% profiles ***

% positions: template electrode positioning. Electrodes from 1 to
% 64 follow the order stated in 'example_electrodes' folder.
...
%  coordinates
% 
%% d_sort considers the distance profile for the electrodes in the properly labelled cap

% Define electrodes matrix


% Load XYZ electrode file if string
...
% If it is not a string then load as matrix
else
...
% electrode identified as symmetric pairs
...
% separate electrodes if we have duplicated labels (==2). Assuming they
